# Extending OCaml with Security Type System

A small interpreter and static type checker for a typed lambda calculus language implemented in Ocaml.

Currently supports integers, booleans, basic arithmetic, let bindings, functions, and conditionals. The interpreter does not consider security labels as typechecker statcially checks before interpretation/evaluation.

## Getting Started

Note that this was written mainly for Apple Scilicon MacOS. Follow directions at OCaml website for instructions in other OS.
